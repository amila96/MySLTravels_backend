const MirissaReviewDTO= require('../model/MirissaReviewDTO');
...
const saveReview = (req, resp) => {
    try {
        ...
        const mirissaReview = new MirissaReviewDTO({
            name: req.body.name,
            comment: req.body.comment
        });

        mirissaReview.save().then(result => {
...
const getAllReviews = (req, resp) => {
    try {
        // pagination
        MirissaReviewDTO.find().then(result => {
