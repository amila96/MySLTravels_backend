const HortonPlainsReviewDTO= require('../model/HortonPlainsReviewDTO');
...
const saveReview = (req, resp) => {
    try {
        ...
        const hortonPlainsReview = new HortonPlainsReviewDTO({
            name: req.body.name,
            comment: req.body.comment
        });

        hortonPlainsReview.save().then(result => {
...
const getAllReviews = (req, resp) => {
    try {
        // pagination
        HortonPlainsReviewDTO.find().then(result => {
